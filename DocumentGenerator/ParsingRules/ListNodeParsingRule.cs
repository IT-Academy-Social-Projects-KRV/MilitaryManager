            ...
            if (attributes != null)
            {
                ...
                if (ModelValues.ContainsKey(dataPropName))
                {
                    ...
                    foreach (var item in jsonArray)
                    {
                        ...
                        pdfGenerator.AddTextBlock(GetDataForText(text), atrData.FontSize, atrData.Style,
                            atrData.Alignment);
                        if (retAttribute != null) pdfGenerator.AddRetreat(Convert.ToDouble(retAttribute.Value));
                        id++;
                    }
                }
            }
