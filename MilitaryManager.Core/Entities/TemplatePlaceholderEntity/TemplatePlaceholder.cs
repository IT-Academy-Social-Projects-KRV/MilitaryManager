    ...
    public class TemplatePlaceholder : IBaseEntity<int>
    {
        ...
        public List<TemplatePlaceholder> GetTemplatePlaceholders()
        {
            List<TemplatePlaceholder> placeholders = new List<TemplatePlaceholder>()
            {
                ...
                new TemplatePlaceholder() { Id = 27, Name = "currentDate", TemplateId = 3 },
                new TemplatePlaceholder() { Id = 28, Name = "decreeNumber", TemplateId = 3 },
                new TemplatePlaceholder() { Id = 29, Name = "lastName", TemplateId = 3 },
                new TemplatePlaceholder() { Id = 30, Name = "firstName", TemplateId = 3 },
                new TemplatePlaceholder() { Id = 31, Name = "secondName", TemplateId = 3 },
                new TemplatePlaceholder() { Id = 32, Name = "divisionNumber", TemplateId = 3 },
                new TemplatePlaceholder() { Id = 33, Name = "commanderDivision", TemplateId = 3 },
                new TemplatePlaceholder() { Id = 34, Name = "commanderRank", TemplateId = 3 },
                new TemplatePlaceholder() { Id = 35, Name = "commanderLastName", TemplateId = 3 },
                new TemplatePlaceholder() { Id = 36, Name = "commanderFirstName", TemplateId = 3 },
                new TemplatePlaceholder() { Id = 37, Name = "commanderSecondName", TemplateId = 3 },
            };
